 ...
 * This class is for the Medium-play algorithm responsible.
 */
public class MediumPlayService {
    ...
    /**
     * Check a single row for the doubled occurrence of the same state. If this case matches, the number of the empty
     * field will be returned. In this case, the computer will place his sign into that field.
     *
     * @param positions         String Array with all positions and their state
    ...
    /**
     * Check a single row for the doubled occurrence of the state, which the computer is playing with. If this case matches, the number of the empty
     * field will be returned. In this case, the computer will place his sign into that field.
     *
     * @param positions         String Array with all positions and their state
     * @param nr1               int field number one to check
     ...
     * @param checkedRowsNumber int row number (first row = 1, second row = 2, third row = 3)
     * @return result int with fieldnumber. If no case matches, the default value will be returned
     */
    ...
    /**
     * Check all horizontal rows, if there is a chance to win.
     *
     * @param positions     String Array with all positions and their state
     * @param computersChar char with computers character ('x' or 'o')
     * @return result int fieldnumber. If no case matches, the default value will be returned
     */
    ...
    /**
     * Check all vertical rows, if there is a chance to win.
     *
     * @param positions     String Array with all positions and their state
     * @param computersChar char with computers character ('x' or 'o')
     * @return result int fieldnumber. If no case matches, the default value will be returned
    ...
    /**
     * Check all crosses, if there is a chance to win.
     *
     * @param positions     String Array with all positions and their state
     * @param computersChar char with computers character ('x' or 'o')
     * @return result int fieldnumber. If no case matches, the default value will be returned
